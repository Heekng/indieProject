					...
					<section id="content">
						...
						<fieldset id="movie"
							...
							<div style="text-align: center;">
								<c:if test="${nowPage>1}">
									<a
										href="${pageContext.request.contextPath}/member/memberMyReview.me?page=${nowPage-1}">[이전]</a>
								</c:if>
								...
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
									<c:choose>
										...
										<c:otherwise>
											<a
												href="${pageContext.request.contextPath}/member/memberMyReview.me?page=${i}">${i}&nbsp;</a>
										</c:otherwise>
									</c:choose>
								</c:forEach>
								<c:if test="${realEndPage != nowPage}">
									<a
										href="${pageContext.request.contextPath}/member/memberMyReview.me?page=${nowPage + 1}">[다음]</a>
								</c:if>
