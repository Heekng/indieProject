 ...
 * Generated at: 2021-04-12 01:00:37 UTC
...
public final class movieWrite_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<option value=\"drama\">드라마</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"horror\">공포 / 스릴러</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"fantasy\">판타지</option>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<option value=\"12\">12세이상관람가</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"15\">15세이상관람가</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"19\">청소년관람불가</option>\n");
      out.write("\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"row\">\n");
