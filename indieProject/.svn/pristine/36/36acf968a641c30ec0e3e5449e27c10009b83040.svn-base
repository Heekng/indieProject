...
public class MemberDAO {
	...
	//영화제목 출력
	public List<AmaMovieVO> getMovieTitle(String memberId)  throws Exception {
		return session.selectList("Member.amaMovieTitle",memberId);
	}
	//팝콘 사용내역 리스트 가져오기
	...
	public void popcornCharge(int popCorn) {
		session.update("Member.popcornCharge",popCorn);
	}
