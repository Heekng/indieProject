		...
		<div class="container">
			...
			<div class="row" style="margin-bottom: 1em;">
				<ul class="actions" style="margin: 0 auto;">
					<li>
						<a href="${pageContext.request.contextPath}/manager/managerNoneRefunds.ma" class="button alt">미처리 환급</a>
					</li>
					<li>
						<a href="${pageContext.request.contextPath}/manager/managerRefunds.ma" class="button alt">처리된 환급</a>
					</li>
					<li>
						<a href="${pageContext.request.contextPath}/manager/managerRefunds.ma" class="button primary">영화 삭제</a>
					</li>
				</ul>
			</div>
			<!-- Content -->
