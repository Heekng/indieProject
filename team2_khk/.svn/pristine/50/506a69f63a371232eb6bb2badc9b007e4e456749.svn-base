			...
			<div class="row">
				<div class="col-6 col-9-medium col-12-small" style="margin: auto;">
					<fieldset class="fieldset"
						style="border: solid; border-style: outset; padding-left: 5%; padding-top: 3%; ppadding-right: 0%;">
						<div id="idPw_Signup" class="div"
							style="margin: 0 auto; postion: relative; z-index: 1;">
							<form method="post" action="#" name="id_pw">
								<br> <label for="name" style="margin-bottom: 0px;">이름</label>
								<div class="col-6 col-12-small">
									<input type="text" name="name" id="name" value=""
										style="width: 94%;" />
								</div>
								<label for="id" style="margin-bottom: 0px;">아이디 </label>
								<div class="col-6 col-12-small">
									<input type="text" name="id" id="id" value=""
										style="width: 94%; padding-top: 27px;" />
								</div>
								<p id="pwCheck_text"
									style="font-size: 80%; smargin-bottom: 0px; margin-bottom: 0%;">사용가능한
									아이디 입니다.</p>

								<label for="pw" style="margin-bottom: 0px;">비밀번호</label>
								<div class="col-6 col-12-small">
									<input type="text" name="pw" id="pw" value=""
										style="width: 47%; margin-bottom: 10px; display: inline;"
										placeholder="" /> <input type="text" name="pwCheck"
										id="pwCheck" value="" style="width: 46%; display: inline;"
										placeholder="확인" />
								</div>

								<p style="font-size: 80%;">영문 숫자 포함 8자리 이상을 사용하세요</p>

								<ul class="actions stacked">
									<li style="text-align: center;"><a id="frist_nextButton"
										class="button" style="margin-right: 5%;"
										onclick="email_signup()" id="button">다음</a></li>
								</ul>
							</form>
						...
						<div id="email_Signup" class="div" style="display: none;">
							<form method="post" action="#" name="email_check">
								<h1 style="margin-top: 6%;">이메일 인증</h1>
								<p id="text_1" style="font-size: 100%; margin-bottom: 10%;">더
									많은 IndieProject를 즐기기위해 본인인증을 진행해주세요.</p>
								<!-- <div style="display:flex;">  -->
								<div class="col-12">
									<div class="row maker">
										<input type="text" name="email" id="email" value=""
											style="display: inline; width: 38%; margin-left: 6%;" /> <select
											name="category" id="category"
											style="display: inline; width: 38%;">
										...
										<div class="col-1 col-12-small" style="padding: 0;">
											<a href="#" class="button alt small" id="button">전송</a>
										</div>
									</div>
								</div>
								<!-- </div> -->
								<div class="col-12">
									<div class="row maker">
										<input type="text" name="emailCheck" id="emailCheck" value=""
											style="display: inline; width: 76%; margin-left: 6%;"
											placeholder="인증번호" />
										<div class="col-1 col-12-small" style="padding: 0;">
											<a href="#" class="button alt small">확인</a>
										</div>
										<br>
									</div>
								</div>
								<ul class="actions stacked">
									<li style="text-align: center;"><a class="button"
										onclick="backfirst_signup()">이전</a> <a class="button alt"
										style="margin-right: 5%;" onclick="check_Signup()">다음</a></li>
								</ul>
							</form>
							<!-- 		</fieldset> -->
						</div>
						...
						<div id="check_Signup" class="div" style="display: none;">
							<!-- 	 <fieldset style="border:solid; border-style: outset; padding-left:8%; padding-top:10%; padding-bottom:4%;  padding-right:5%;"> -->
							<form method="post" action="#" name="email_check">
								<br> <label>이용약관</label>
								<textarea name="message" placeholder="Enter your message"
									rows="6" readonly style="width: 93%;">
시행일자 : 2020년 11월 16일
...
본 약관은 2020년 11월 16일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
								...
								<input type="checkbox" id="copy" onclick="btn_check()">
								<label for="copy"> <span
									style="color: red; font-weight: 900">[필수]</span>약관 및 개인정보 수집/이용
									동의
								</label>
								<textarea name="message" placeholder="Enter your message"
									rows="6" readonly style="width: 93%;">
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
								...
								<input type="checkbox" id="copy" onclick="btn_check()">
								<label for="copy"> <span
									style="color: red; font-weight: 900">[필수]</span>전자상거래 표준/이용 동의
								</label>
								<ul class="actions stacked">
									<li style="text-align: center;"><a class="button"
										onclick="back()">이전</a> <a class="button alt"
										style="margin-right: 5%;" onclick="singupSubmit()"
										id="singupSubmit()">회원가입</a></li>
								</ul>
							</form>
						</div>


						<div id="signup_finish" class="div" style="display: none;">
							<div style="text-align: center; margin-top: 10%;">
								<h2 style="color: #000000; margin-right: 5%;">회원가입 완료</h2>
								<p>임시은 고객님의 가입을 진심으로 환영합니다</p>
							</div>
							<ul class="actions stacked">
								<li style="text-align: center;"><a href="#" class="button"
									id="button">로그인</a> <a href="#" class="button alt" id="button">홈으로</a></li>
							</ul>
						</div>
						<!-- </fieldset> -->
					</fieldset>
